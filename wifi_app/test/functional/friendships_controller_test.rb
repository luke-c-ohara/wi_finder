...
class FriendshipsControllerTest < ActionController::TestCase
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post :create, friendship: { friend_id: @friendship.friend_id, network_id: @friendship.network_id, user_id: @friendship.user_id }
    end
  ...
  test "should update friendship" do
    put :update, id: @friendship, friendship: { friend_id: @friendship.friend_id, network_id: @friendship.network_id, user_id: @friendship.user_id }
    assert_redirected_to friendship_path(assigns(:friendship))
  end
