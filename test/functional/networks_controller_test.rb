...
class NetworksControllerTest < ActionController::TestCase
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post :create, network: { location: @network.location, nickname: @network.nickname, password: @network.password, public_private: @network.public_private, ssid: @network.ssid, user_id: @network.user_id }
    end
  ...
  test "should update network" do
    put :update, id: @network, network: { location: @network.location, nickname: @network.nickname, password: @network.password, public_private: @network.public_private, ssid: @network.ssid, user_id: @network.user_id }
    assert_redirected_to network_path(assigns(:network))
  end
